...
import (
	...
	"github.com/benderr/keypass/internal/server/domain/user/delivery"
	"github.com/benderr/keypass/internal/server/domain/user/delivery/mocks"
...
func TestLogin(t *testing.T) {
	...
	t.Run("Invalid contract", func(t *testing.T) {
		...
		assert.JSONEq(t, string(resp.Body()), `{"message": "Key: 'User.Password' Error:Field validation for 'Password' failed on the 'required' tag"}`)
	})
}
